...
import type { FFmpegAssetUrls } from "../compression/types";

const DEFAULT_FFMPEG_BASE_URL = "/ffmpeg/";
...
/**
 * Gets the shared FFmpeg instance.
 */
...
/**
 * Ensures the shared FFmpeg instance is loaded and ready for use.
 */
...
export function resolveFFmpegAssetUrls(): FFmpegAssetUrls {
  if (_ffmpegAssetUrls) {
    return {
